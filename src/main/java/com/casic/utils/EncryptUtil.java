	 ...
	 private static final String key = "@#$%^6a7";
		...
		/*     */{
			...
			/*     */{
				...
				/*  55 */return new String(Base64.encodeBase64(digest));
			} catch (Exception e) {
				/*     */}
			/*  57 */return null;
			/*     */}
		...
		/*     */{
			...
			/*  94 */DESKeySpec desKeySpec = new DESKeySpec(
					"@#$%^6a7".getBytes("UTF-8"));
			/*  95 */SecretKeyFactory keyFactory = SecretKeyFactory
					.getInstance("DES");
			/*  96 */SecretKey secretKey = keyFactory.generateSecret(desKeySpec);
			/*  97 */IvParameterSpec iv = new IvParameterSpec(
					"@#$%^6a7".getBytes("UTF-8"));
			/*     */
		...
		/*     */{
			...
			/*     */
			/* 114 */DESKeySpec desKeySpec = new DESKeySpec(
					"@#$%^6a7".getBytes("UTF-8"));
			/*     */
			/* 116 */SecretKeyFactory keyFactory = SecretKeyFactory
					.getInstance("DES");
			/* 117 */SecretKey secretKey = keyFactory.generateSecret(desKeySpec);
			/* 118 */IvParameterSpec iv = new IvParameterSpec(
					"@#$%^6a7".getBytes("UTF-8"));
			/* 119 */cipher.init(1, secretKey, iv);
			/*     */
			/* 121 */String str = bytesToString(cipher.doFinal(message
					.getBytes("UTF-8")));
			/* 122 */return str;
			/*     */}
